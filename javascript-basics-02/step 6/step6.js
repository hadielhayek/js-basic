document.querySelector("#image1").addEventListener("mouseover",change);
document.querySelector("#image2").addEventListener("mouseover",change);
document.querySelector("#image3").addEventListener("mouseover",change);
document.querySelector("#image4").addEventListener("mouseover",change);
document.querySelector("#image5").addEventListener("mouseover",change);
function change(){
